        ...
        <div style={{width: '100%'}}>
          <Container className='h-screen px-20' style={{backgroundColor:'white'}}>
            ...
            <div className='flex flex-col'>
              <h3 style={{color:'black', fontWeight: 'bold', fontSize: '30px', marginTop: 100}}>Verifikasi Otp</h3>
              <TextField id="standard-basic" label="Email" variant="standard" sx={{width: 'full', marginTop: '20px'}} />
              <TextField id="standard-basic" label="OTP" variant="standard" sx={{width: 'full', marginTop: '20px'}} />
              <Button variant="contained" style={{backgroundColor: '#2395FF'}} sx={{width: 'full', marginTop: '20px', marginBottom: '20px'}}>Verify</Button>
            </div>
          </Container>
        </div>
      </div>
